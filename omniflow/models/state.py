...
from omniflow.agents.planner import Plan
...
class AgentState(BaseModel):
    ...
    intent_result: IntentResult | None = Field(
        default=None,
        description="Full structured result from omniflow.agents.intent.understand_intent(), "
    ...
    plan: Plan | None = Field(
        default=None,
        description="Structured plan produced by the planner (see omniflow.agents.planner.Plan). "
    ...
    validation_issues: list[str] = Field(
        ...
        "(omniflow.agents.validator.validate_structure), if any -- e.g. a missing required "
