...
# Anchored to the project root (this file's parent's parent), independent of
# process cwd -- same reasoning as config.py's _PROJECT_ROOT_ENV_FILE. Not a
# committed artifact: it holds a given machine's local conversation history.
DB_PATH = Path(__file__).resolve().parent.parent.parent / "omniflow_history.db"
