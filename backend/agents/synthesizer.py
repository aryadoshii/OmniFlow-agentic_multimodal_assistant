...
(see ``backend.agents.validator``), not through a response schema.
"""
...
# not added to Settings (mirrors backend.agents.intent's _MAX_DOCUMENT_PREVIEW_CHARS).
...
def synthesize_answer(
    ...
    Args:
        ...
        correction_feedback: When set, a concise description of the
                              ...
                              backend.agents.validator.validate_structure)
